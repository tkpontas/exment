...
return [
    ...
    'common' => [
        ...
        'message' => [
            ...
            'no_permission' => '********',
            'file_drag_drop' => 'ファイルをここにドラッグ＆ドロップしてください',
    ...
    'error' => [
        ...
        'mailsend_failed' => 'メール送信に失敗しました。メール設定とシステムログファイルをご確認ください。',
        ...
        'ip_address_filtered' => 'あなたの接続環境からのアクセスは許可されていません。',
        'not_contains_column' => 'カスタム列に設定されていない項目が含まれています。',
        'public_form_not_found' => '該当の入力フォームがありませんでした。URLが誤っているか、有効期限が切れている可能性があります。',
    ...
    'user' => [
        'header' => '利用者ログイン許可',
        'description' => '利用者が利用者コードとパスワードを使ったログインすることを許可または禁止にします。パスワードの設定や、パスワード初期化を行えます。',
        'user_code' => '利用者コード',
        'user_name' => '利用者氏名',
        'email' => '認証用メールアドレス',
        'password' => 'パスワード',
        ...
        'send_password' => '利用者情報をメール送信する',
        'login_user' => '利用者ログイン許可',
        'login' => 'ログイン設定',
        ...
        'help' =>[
            ...
            'use_loginuser' => 'YESにすることで、この利用者がこのシステムに利用者コードとパスワードでログインすることができるようになります。',
            'reset_password' => 'YESにすることで、パスワードが再設定されます。',
            'create_password_auto' => 'YESにすることで、パスワードが自動生成されます。(該当利用者にメールが送信されます)',
            'send_password' => 'YESにすることで、該当利用者に利用者情報をメール送信します。',
            'password_change' => 'パスワードの有効期限が過ぎています。',
            'first_change_password' => '新しいパスワードを設定してください。',
            'password_reset_flg' => 'YESにすることで、利用者が初めてログインを行う時、パスワードを変更する画面を表示します。',
        ],
        'message' => [
    ...
    'login' => [
        ...
        'sso_provider_error' => 'ログイン情報取得に失敗しました。何度も失敗する場合、管理者にお問い合わせください。',
        'noexists_user' => 'このアカウントは利用者登録されていないか、ログインが許可されていません。ログインできなくなった場合は管理者に直接お問い合わせください。',
        'throttle' => 'ログイン試行回数が基準値を超えたため、該当アカウントのログインを停止・アカウントロックしました。アカウント再発行が必要ですので、管理者に直接お問い合わせください。',
        'not_accept_domain' => ':domainでのログインは、許可されていません。',
        'login_button_format' => ':display_nameでログイン',
        'sso_provider_error_validate' => '取得したログイン情報に問題がありました。以下の内容をご確認いただき、管理者にお問い合わせください。:errors',
    ...
    '2factor' => [
        ...
        '2factor_provider_options' => [
            'email' => 'メール受信',
            'google' => 'Google Authenticatorアプリ',
        ],
    ],
    ...
    'workflow' => [
        'header' => '承認経路・進捗設定',
        'description' => '承認経路・進捗を設定します。申請、承認、却下など、特定のユーザーが手順を実行することができます。',
        'workflow_view_name' => '承認経路・進捗表示名',
        'workflow_edit_flg' => '編集権限の付与',
        'workflow_type' => '承認経路・進捗種類',
        'workflow_statuses' => 'ステータス設定',
        'workflow_actions' => 'アクション設定',
        'description_workflow_statuses' => '承認経路・進捗で使用するステータスを定義します。例：承認待ち、完了<br />※表の最終行のステータスは、フロー完了を表すものとしてください。',
        'description_workflow_actions' => '状態を変化させるアクションを定義します。 例：申請、承認、決裁',
        'execute_workflow' => '実行中手順',
        'action' => 'アクション',
        'status' => 'ステータス',
        'status_name' => 'ステータス名',
        'current_status_name' => '現在のステップ',
