...
return [
    ...
    'system' => [
        ...
        'date_format_list' => [
            ...
            'format_slash' => ['Y/m/d(D)', 'Y/m/d(D) H:i', 'H:i'],
            'format_local' => ['Y年m月d日', 'Y年m月d日 H:i', 'H時i分'],
        ],
    ...
    'login' => [
        ...
        'password_reset' => 'パスワードを初期化',
        'back_login_page' => 'ログインページに戻る',
        'sso_provider_error' => 'ログイン情報を取得できませんでした。',
        'noexists_user' => 'ログインに使用しているアカウントをもう一度ご確認ください。',
    ...
    'menu' => [
        ...
        'system_definitions' => [
            ...
            'workflow' => 'ワークフロー',
            'user' => '利用者',
            'organization' => '利用者グループ',
            'mail_template' => '通知テンプレート',
            'mail' => 'メール送信履歴',
            'operation_log' => '操作ログ',
